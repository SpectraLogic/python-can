...
class Usb2CanAbstractionLayer:
    ...
    def open(self, configuration, flags):
        ...
        try:
            ...
            raise pycan.CanError('CanalOpen() failed, configuration: "{}", error: {}'
            ...
            if result <= 0:
                raise pycan.CanError('CanalOpen() failed, configuration: "{}", return code: {}'
    ...
    def send(self, handle, msg):
        try:
            ...
            raise pycan.CanError("Failed to transmit frame")
