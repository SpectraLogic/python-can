...
from pycan import CanError, BusABC, Message
...
class NicanBus(BusABC):
    ...
    .. warning::
        ...
        the filters have to be set in :meth:`~pycan.interfaces.nican.NicanBus.__init__`
        using the ``can_filters`` parameter. Using :meth:`~pycan.interfaces.nican.NicanBus.set_filters`
        does not work.
    ...
    def __init__(self, channel, can_filters=None, bitrate=None, log_errors=True, **kwargs):
        ...
        :raises pycan.interfaces.nican.NicanError:
    ...
    def set_filters(self, can_filers=None):
        """Unsupported. See note on :class:`~pycan.interfaces.nican.NicanBus`.
        """
