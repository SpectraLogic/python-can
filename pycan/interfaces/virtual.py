...
and residing in the same process will receive the same messages.
"""
...
from pycan.bus import BusABC
from pycan import CanError
...
class VirtualBus(BusABC):
    ...
    Implements :meth:`pycan.BusABC._detect_available_configs`; see
    :meth:`pycan.VirtualBus._detect_available_configs` for how it
    behaves here.
