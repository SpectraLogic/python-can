...
log = logging.getLogger("pycan.io.logger")
...
class Logger(BaseIOHandler, Listener):
    ...
    The format is determined from the file format which can be one of:
      * .asc: :class:`pycan.ASCWriter`
      * .blf :class:`pycan.BLFWriter`
      * .csv: :class:`pycan.CSVWriter`
      * .db: :class:`pycan.SqliteWriter`
      * .log :class:`pycan.CanutilsLogWriter`
      * other: :class:`pycan.Printer`
    ...
    def __new__(cls, filename, *args, **kwargs):
        ...
        :param filename: the filename/path the file to write to,
                         ...
                         it, and may be None to instantiate a :class:`~pycan.Printer`
