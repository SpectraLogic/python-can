...
log = logging.getLogger('pycan.io.player')
...
class LogReader(BaseIOHandler):
    ...
    .. note::
        ...
        delays between messages look at the :class:`pycan.MessageSync` class.
...
class MessageSync(object):
    ...
    def __init__(self, messages, timestamps=True, gap=0.0001, skip=60):
        ...
        :param Iterable[pycan.Message] messages: An iterable of :class:`pycan.Message` instances.
