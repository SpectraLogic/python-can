...
Please use ``import pycan`` instead.
"""

from __future__ import absolute_import

from pycan.message import Message
from pycan.listener import Listener, BufferedReader, RedirectReader
from pycan.util import set_logging_level
from pycan.io import *
...
warnings.warn('Loading python-can via the old "CAN" API is deprecated since v3.0 an will get removed in v4.0 '
              'Please use `import pycan` instead.', DeprecationWarning)
