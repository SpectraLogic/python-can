...
class BusState(Enum):
    """The state in which a :class:`pycan.BusABC` can be"""
...
class BusABC(object):
    ...
    def __init__(self, channel, can_filters=None, **kwargs):
        ...
        :param list can_filters:
            See :meth:`~pycan.BusABC.set_filters` for details.
    ...
    def _recv_internal(self, timeout):
        ...
        This methods may be called by :meth:`~pycan.BusABC.recv`
        to read a message multiple times if the filters set by
        :meth:`~pycan.BusABC.set_filters` do not match and the call has
        not yet timed out.

        New implementations should always override this method instead of
        :meth:`~pycan.BusABC.recv`, to be able to take advantage of the
        software based filtering provided by :meth:`~pycan.BusABC.recv`
        ...
        .. note::
            ...
            :meth:`~pycan.BusABC.recv` implementation.
        ...
        :param float timeout: seconds to wait for a message,
                              see :meth:`~pycan.BusABC.send`

        :rtype: tuple[pycan.Message, bool] or tuple[None, bool]
        :return:
        ...
        :raises NotImplementedError:
            if the bus provides it's own :meth:`~pycan.BusABC.recv`
    ...
    def send_periodic(self, msg, period, duration=None, store_task=True):
        ...
        :rtype: pycan.broadcastmanager.CyclicSendTaskABC
    ...
    def __iter__(self):
        ...
        :yields:
            :class:`pycan.Message` msg objects.
        """
        while True:
    ...
    def filters(self):
        """
        Modify the filters of this bus. See :meth:`~pycan.BusABC.set_filters`
        for details.
        """
    ...
    def _matches_filters(self, msg):
        ...
        current filters. See :meth:`~pycan.BusABC.set_filters` for details
