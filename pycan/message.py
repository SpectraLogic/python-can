"""
This module contains the implementation of :class:`pycan.Message`.
...
class Message(object):
    """
    The :class:`~pycan.Message` object is used to represent CAN messages for
    ...
    may introduce unexpected behaviour. See also :meth:`~pycan.Message.equals`.
    ...
    def __repr__(self):
        ...
        return "pycan.Message({})".format(", ".join(args))
    ...
    def equals(self, other, timestamp_delta=1.0e-6):
        ...
        :param pycan.Message other: the message to compare with
