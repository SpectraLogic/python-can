"""
This module contains the base implementation of :class:`pycan.BusABC` as well
...
log = logging.getLogger('pycan.interface')
...
class Bus(BusABC):
    ...
    def __new__(cls, channel=None, *args, **kwargs):
        """
        Takes the same arguments as :class:`pycan.BusABC.__init__`.
        ...
        :param dict kwargs:
            ...
            it is completed using :meth:`pycan.util.load_config`.
...
def detect_available_configs(interfaces=None):
    ...
    :return: an iterable of dicts, each suitable for usage in
             the constructor of :class:`pycan.BusABC`.
    """
