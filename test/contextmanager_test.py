...
class ContextManagerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.msg_send = pycan.Message(is_extended_id=False, arbitration_id=0x100, data=data)

    def test_open_buses(self):
        with pycan.Bus(interface='virtual') as bus_send, pycan.Bus(interface='virtual') as bus_recv:
    ...
    def test_use_closed_bus(self):
        ...
        self.assertRaises(pycan.CanError, bus_recv.recv)
        self.assertRaises(pycan.CanError, bus_send.send, self.msg_send)
